  ...
  <body>
    ...
    <div class="main">
      ...
      <importing:wizardform percent="${importBean.stepsPercent}">
        <c:write key="IF_MSG_MENETLEVELEK_HOVA"/>
        <f:form action="/importing/menetlevelekHova.do">
          <div class="formRow">
            <f:radiogroup name="hova" value="">
              <f:items items="${importFormUtils.etapok}" labelPropertyName="label" valuePropertyName="value"/>
            </f:radiogroup>
          </div>
          <div class="formRow">
