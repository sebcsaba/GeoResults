...
<html>
  ...
  <body>
    ...
    <div class="main">
      <geo:error/>
      <div class="backBar">&lt;&lt; <c:link action="/kozos/nyelv.do?mode=back"><c:write key="BS_VISSZA"/></c:link></div>
      <l:form name="orszag" action="/kozos/nyelv.do?mode=save" title="DC_NYELV_FORDITASA">
        <l:field title="DC_MELYIK_NYELV_NEVE">
